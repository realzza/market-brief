...
import { getUnanalyzedTweets, saveAnalysis } from '@/lib/db';
...
export async function POST(request: Request) {
  try {
    ...
    const unanalyzed = getUnanalyzedTweets(limit) as Array<{
      id: string; text: string; created_at: string; media_urls: string;
    }>;
